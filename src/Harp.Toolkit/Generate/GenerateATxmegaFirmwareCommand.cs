...
class GenerateATxmegaFirmwareCommand : Command
{
    public GenerateATxmegaFirmwareCommand()
        : base("atxmega", "Generate firmware headers and implementation stubs.")
    {
        ...
        {
            Description = "Generate implementation stubs."
        };
